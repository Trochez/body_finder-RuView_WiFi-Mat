...
cc=(ROOT/'apps/mobile/src/campaignControl.ts').read_text();native=(ROOT/'apps/mobile/modules/body-finder-native/android/src/main/java/com/trochez/bodyfindernative/BodyFinderNativeModule.kt').read_text();hp=(ROOT/'apps/mobile/src/humanPresence.ts').read_text();authority=(ROOT/'apps/mobile/src/authority.ts').read_text();version=(ROOT/'apps/mobile/src/version.ts').read_text()
