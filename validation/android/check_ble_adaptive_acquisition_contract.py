...
assert '0.2.0-experimental.11' in version
assert 'reportVersion: 13' in version
assert 'humanScanningEnabled: false' in version
assert app_json['expo']['android']['versionCode']==11
assert app_json['expo']['extra']['releaseIteration']=='experimental.11'
...
print('experimental.11 adaptive acquisition + validation integrity contract OK')
