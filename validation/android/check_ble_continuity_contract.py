...
require('export_auto_finalized_validation_run' in app and 'BodyFinderNative.endValidationRun()' in app,'share auto-finalization contract missing'); require('0.2.0-experimental.13' in version and 'reportVersion: 15' in version,'mobile build is not experimental.13'); require(app_json['expo']['android']['versionCode']==13 and app_json['expo']['extra']['releaseIteration']=='experimental.13','Android release metadata wrong'); require('humanScanningEnabled: false' in version,'human scanning must remain blocked')
print(json.dumps({'contract':'experimental.13 preserves bounded BLE metric continuity','profile_id':'android-ble-lab-v1','fresh_ms':5000,'holdover_max_ms':10000,'hard_expiry_ms':10000,'sigma_aging_m_per_s':0.15,'human_scanning_enabled':False},indent=2))
