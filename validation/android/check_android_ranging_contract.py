...
Experimental.13 preserves the validated COARSE metric/continuity contracts while
...
require("0.2.0-experimental.13" in version, "dev13 version truth missing")
...
print("Android ranging experimental.13 adaptive acquisition/validation-integrity contract: PASS")
